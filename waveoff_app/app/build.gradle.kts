...
dependencies {
    ...
    implementation("androidx.camera:camera-view:1.4.0")  // Optional for camera preview

    implementation("com.squareup.okhttp3:okhttp:4.11.0")
    implementation("org.java-websocket:Java-WebSocket:1.5.3") // For WebSocket support
